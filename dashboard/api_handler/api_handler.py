...
class HandleApiRequest(Base):
	def __init__(self, entity, get_list, entity_id=None, params):
		self.entity = entity
		self.list = get_list
	...
	def api_response_get(self, filter_params={}):
		...
		if self.__base_url and self.__relative_url:
			return self.make_api_call(filter_params)


if __name__ = '__main__':
	params  = {}
	obj = HandleApiRequest(request, "light", get_list=True, entity_id=None)
